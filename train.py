...
from utils.simulation import Robot
...
class TestRun():
    def __init__(self, pop_size, select_perc, error_range, mutate):
        ...
        self.mutate = mutate
        self.robotEA = Controller(self.pop_size, self.select_perc, self.error_range, self.mutate)
    ...
    def train(self, epochs):
        ...
        for epoch in range(epochs):
            ...
            for i in range(len(self.robotEA.population)):
                ...
                self.robotEA.population[i].update_score(Robot(self.robotEA.population[i].NN, epoch, i).results)
